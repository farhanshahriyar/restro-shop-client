...
const Login = () => {
  ...
  const { user, loading, createUser, signIn, googleSignIn } =
        ...
        <div className="mx-auto max-w-screen-md py-12 px-4 sm:px-6 md:max-w-screen-xl md:py-20 lg:py-10 md:px-8">
          <div className="md:pe-8 md:w-1/2 xl:pe-0 xl:w-5/12">
            <h1 className="text-3xl text-gray-800 font-bold md:text-4xl md:leading-tight lg:text-3xl lg:leading-tight dark:text-gray-200">
              <span className="text-[#153E3D] dark:text-blue-500">Restro</span>{" "}
              is here to help. Eat what makes you happy.
            </h1>
            <p className="mt-3 text-base text-gray-500">
              Restro is selling happiness in the form of food. We are here to
              help you to find the best food for you.
            </p>
