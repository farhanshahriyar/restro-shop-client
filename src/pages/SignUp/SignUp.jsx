...
const SignUp = () => {
    ...
    <div>
        <Helmet>
                <title>Restro. - SignUp in Restro.</title>
        </Helmet>
                  ...
                  <div>
                    ...
                    <div className="mt-4 md:mb-12 max-w-2xl">
                      <h1 className="mb-4 font-semibold text-gray-800 text-4xl lg:text-5xl dark:text-gray-200">
                        Fully healthy and fresh food we provide in our shop.
                      </h1>
                      <p className="text-gray-600 dark:text-gray-400">
                        We provide you with a best food in the town. We are here to help you to find the best food for you.
                      </p>
                    </div>
                    ...
                    <blockquote className="hidden md:block relative max-w-sm">
                      ...
                      <div className="relative z-10">
                        <p className="text-xl italic text-gray-800 dark:text-white">
                          Amazing people are working in Restro Food Shop and they are providing best food in the town.
                        </p>
                      </div>
